...
const oldPremiumAuthor = `<div className="mt-3 flex items-center justify-between">
...
const newPremiumAuthor = `<div className="mt-4 flex items-center justify-between border-t border-zinc-800 pt-3">
...
content = content.replace(oldPremiumAuthor, newPremiumAuthor);
